...
![](http://cdn.oyjy.top/copydir/2021-06-08-12:16:27--7748831214014548570)

在sys\_open函数中，会调用create函数。

![](http://cdn.oyjy.top/copydir/2021-06-08-12:16:27-7509496649894607861)

create函数中首先会解析路径名并找到最后一个目录，之后会查看文件是否存在，如果存在的话会返回错误。之后就会调用ialloc（inode allocate），这个函数会为文件x分配inode。ialloc函数位于fs.c文件中。

![](http://cdn.oyjy.top/copydir/2021-06-08-12:16:28--793456016448703092)
...
![](http://cdn.oyjy.top/copydir/2021-06-08-12:16:28-5938491640901476445)

bread函数首先会调用bget函数，bget会为我们从buffer cache中找到block的缓存。让我们看一下bget函数

![](http://cdn.oyjy.top/copydir/2021-06-08-12:16:28--7795807471784256045)
...
![](http://cdn.oyjy.top/copydir/2021-06-08-12:16:29--1862840343520058291)
