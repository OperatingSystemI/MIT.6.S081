...
![](http://cdn.oyjy.top/copydir/2021-06-08-12:17:22-515538897954734879)

之后系统调用需要读写block，它可以通过get获取block在buffer中的缓存，同时告诉handle这个block需要被读或者被写。如果你需要更改多个block，类似的操作可能会执行多次。之后是修改位于缓存中的block。

![](http://cdn.oyjy.top/copydir/2021-06-08-12:17:22-9004989267698929005)

当这个系统调用结束时，它会调用stop函数，并将handle作为参数传入。

![](http://cdn.oyjy.top/copydir/2021-06-08-12:17:23--2676017201119652001)
